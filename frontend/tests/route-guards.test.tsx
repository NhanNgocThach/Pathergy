...
describe("AuthGuard", () => {
  it("redirects an unauthenticated user to login", async () => {
    render(<I18nProvider><AuthContext.Provider value={{ ...functions, user: null, isLoading: false }}><AuthGuard><p>Protected content</p></AuthGuard></AuthContext.Provider></I18nProvider>);
  ...
  it("allows authenticated route access", () => {
    render(<I18nProvider><AuthContext.Provider value={{ ...functions, user: currentUser, isLoading: false }}><AuthGuard><p>Protected content</p></AuthGuard></AuthContext.Provider></I18nProvider>);
